...
public class NotificationActivity extends AppCompatActivity {
  ...
  /*      // Add onClick handlers to all the buttons.
    ...
    public void sendNotification() {
        ...
        notifyBuilder.addAction(R.drawable.ic_menu_slideshow, getString(R.string.update), updatePendingIntent);
    ...
    public void updateNotification() {
        ...
        Bitmap androidImage = BitmapFactory.decodeResource(getResources(), R.drawable.ic_menu_camera);
